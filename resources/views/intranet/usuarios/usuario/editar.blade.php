...
<div class="row d-flex justify-content-center">
    <form class="col-12 form-horizontal" action="{{ route('usuarios.update',['id'=>$usuario_edit]) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        @csrf
        @method('put')
...
<script src="{{ asset('js/intranet/usuarios/usuario/editar.js') }}"></script>
@endsection
