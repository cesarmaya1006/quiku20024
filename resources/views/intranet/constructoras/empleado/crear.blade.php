...
<i class="fas fa-project-diagram mr-3" aria-hidden="true"></i> Configuración Empleados Constructora - {{$constructora->constructora}}
@endsection
...
<li class="breadcrumb-item active">Constructoras-Editar-Empleados-Crear</li>
@endsection
...
<div class="row d-flex justify-content-center">
    <form class="col-12 form-horizontal" action="{{ route('constructora.empleados.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        @csrf
        @method('post')
        @include('intranet.constructoras.empleado.form')
        <div class="row mt-5">
...
<script src="{{ asset('js/intranet/constructoras/empleado/crear.js') }}"></script>
@endsection
