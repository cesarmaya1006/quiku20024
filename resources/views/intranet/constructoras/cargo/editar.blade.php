...
<i class="fas fa-project-diagram mr-3" aria-hidden="true"></i> Configuración Cargos Constructora - {{$constructora->constructora}}
@endsection
...
<li class="breadcrumb-item active">Constructoras-Editar-Cargos-Editar</li>
@endsection
...
<div class="row d-flex justify-content-center">
    <form class="col-12 form-horizontal" action="{{ route('constructora.cargos.update',['constructora_id'=>$constructora->id,'id'=>$cargo_edit]) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        @csrf
        @method('put')
