...
<li class="breadcrumb-item active">Constructoras-Editar-Cargos-Crear</li>
@endsection
...
<div class="row d-flex justify-content-center">
    <form class="col-12 form-horizontal" action="{{ route('constructora.cargos.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        @csrf
        @method('post')
