...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Publicidad - Crear</li>
@endsection

@section('titulo_card')
    <i class="fa fa-plus-square mr-3" aria-hidden="true"></i> Crear Publicidad
@endsection
...
<div class="row d-flex justify-content-center">
    <form class="col-12 form-horizontal" action="{{ route('publicidad.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        @csrf
        @method('post')
...
<script src="{{ asset('js/intranet/publicidad/crear.js') }}"></script>
@endsection
