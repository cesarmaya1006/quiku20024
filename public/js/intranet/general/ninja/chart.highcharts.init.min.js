!(function (e) {
    ...
    e(document).ready(function () {
        return (
            e("#3d-highcharts").length && t.bar_3d(),
            e("#3dscatter-highcharts").length && t.pie_3d(),
            e("#3d-highcharts").length && t.scatter_3d(),
            e("#3dstacking-highcharts").length && t.stacking_3d(),
            e("#random-highcharts").length && t.random_data(),
            e("#click-highcharts").length && t.click_data(),
            !1
        );
    }),
        ...
        (t = {
            bar_3d: function () {
                new Highcharts.Chart({
                    ...
                    series: [
                        {
                            data: [
                                29.9, 71.5, 106.4, 129.2, 144, 176, 135.6,
            ...
            scatter_3d: function () {
                Highcharts.getOptions().colors = e.map(
                ...
                e(t.container).on("mousedown.hc touchstart.hc", function (a) {
                    a = t.pointer.normalize(a);
                    var i,
                        r,
                        o = a.pageX,
                        l = a.pageY,
                        n = t.options.chart.options3d.alpha,
                        d = t.options.chart.options3d.beta,
                        s = 5;
                    e(document).on({
                        "mousemove.hc touchdrag.hc": function (e) {
                            (r = d + (o - e.pageX) / s),
                                (t.options.chart.options3d.beta = r),
                                (i = n + (e.pageY - l) / s),
                                (t.options.chart.options3d.alpha = i),
                                t.redraw(!1);
                        },
            ...
            stacking_3d: function () {
                e("#3dstacking-highcharts").highcharts({
                    chart: {
                        type: "column",
                        options3d: {
                            enabled: !0,
            ...
            random_data: function () {
                Highcharts.setOptions({ global: { useUTC: !1 } }),
                    e("#random-highcharts").highcharts({
                        chart: {
                            type: "spline",
